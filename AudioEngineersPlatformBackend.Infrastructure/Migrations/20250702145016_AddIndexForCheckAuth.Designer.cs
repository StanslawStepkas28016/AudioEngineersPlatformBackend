...
namespace AudioEngineersPlatformBackend.Infrastructure.Migrations
{
    ...
    [Migration("20250702145016_AddIndexForCheckAuth")]
    partial class AddIndexForCheckAuth
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AudioEngineersPlatformBackend.Domain.Entities.AdvertLog", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            IdAdvertLog = new Guid("1b84601e-e225-4e9d-93d2-911fb0a1569e"),
                            DateCreated = new DateTime(2025, 7, 2, 14, 50, 16, 364, DateTimeKind.Utc).AddTicks(1550),
                            IsActive = true,
                            IsDeleted = false
                        },
                        new
                        {
                            IdAdvertLog = new Guid("a9e9762a-2a67-46f3-b371-50405a100d58"),
                            DateCreated = new DateTime(2025, 7, 2, 14, 50, 16, 364, DateTimeKind.Utc).AddTicks(6830),
                            IsActive = true,
                            IsDeleted = false
                        },
                        new
                        {
                            IdAdvertLog = new Guid("b3d2dce1-a858-4312-937d-c56a6e0178cf"),
                            DateCreated = new DateTime(2025, 7, 2, 14, 50, 16, 364, DateTimeKind.Utc).AddTicks(6840),
                            IsActive = true,
                            IsDeleted = false
                        },
                        new
                        {
                            IdAdvertLog = new Guid("efe85186-52c9-4c46-b585-d4b47523db47"),
                            DateCreated = new DateTime(2025, 7, 2, 14, 50, 16, 364, DateTimeKind.Utc).AddTicks(6870),
                            IsActive = true,
                            IsDeleted = false
                        },
                        new
                        ...
                        {
                            IdAdvertLog = new Guid("fe0d1832-793e-4cf8-983a-bbe09d7e0fa2"),
                            DateCreated = new DateTime(2025, 7, 2, 14, 50, 16, 364, DateTimeKind.Utc).AddTicks(6890),
                            IsActive = true,
                            IsDeleted = false
                        },
                        new
                        {
                            IdAdvertLog = new Guid("993648ca-9d51-419a-85e8-046e8fc3162b"),
                            DateCreated = new DateTime(2025, 7, 2, 14, 50, 16, 364, DateTimeKind.Utc).AddTicks(6900),
                            IsActive = true,
                            IsDeleted = false
                        },
                        new
                        ...
                        {
                            IdAdvertLog = new Guid("70820368-d390-4c01-af1f-9e7b8e8413d2"),
                            DateCreated = new DateTime(2025, 7, 2, 14, 50, 16, 364, DateTimeKind.Utc).AddTicks(6910),
                            IsActive = true,
                            IsDeleted = false
                        });
                });
            ...
            modelBuilder.Entity("AudioEngineersPlatformBackend.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            LastName = "Kowalski",
                            Password = "AQAAAAIAAYagAAAAEEY0VpwQ2ylfAGJDmdqIN/oKn2d92DTAukwsChscp5jrqgP6VzDnqNPHZNCNt7u9rw==",
                        ...
                        new
                        {
                            ...
                            LastName = "Nowak",
                            Password = "AQAAAAIAAYagAAAAENZhOXEWpZJcjgu9M+8cFjxnp9k8fCfPxEDLvd5pRgy+Msa+7NeMLnHqv45fw+b5AQ==",
                        ...
                        new
                        {
                            ...
                            LastName = "Kowalska",
                            Password = "AQAAAAIAAYagAAAAEOmZKkgnpg/1hQvoMpXmT+iOt9cAeLubGwwitpqnCjKCtpC1/ScFPUQdQvK2noW22g==",
                        ...
                        new
                        {
                            ...
                            LastName = "Nowak",
                            Password = "AQAAAAIAAYagAAAAEONOjd1XatXtPdXqyNsDBt+ezdMeXjnTzebylO3hvyHZDDOnBmro+yAxieoeiYMWZg==",
                        ...
                        new
                        {
                            ...
                            LastName = "Maj",
                            Password = "AQAAAAIAAYagAAAAENUNJcxwJUw7VipksRBAQa9dsDBQN2O8aFNUeDaSUjhfmOwzE9Q2KYHp3J+YgpmZ2Q==",
                        ...
                        new
                        {
                            ...
                            LastName = "Zieliński",
                            Password = "AQAAAAIAAYagAAAAEPVDhtdMCLmR1IwONwg6sJe6p3MjzpoYJhUAEpZNwwKHpgEljS/V4/crH+mvarShKw==",
                        ...
                        new
                        {
                            ...
                            LastName = "Wójcik",
                            Password = "AQAAAAIAAYagAAAAEI6HhAyHbv++C1eZiopSxu/VlN6LkfeNdNOtUo6sgeAlMZpKITT/pvrm1iokwNWYMQ==",
                        ...
                        new
                        {
                            ...
                            LastName = "Wiśniewska",
                            Password = "AQAAAAIAAYagAAAAEKzxhEwbvTapkceMNlDJHBcLt8PqamlgDeQfc3sItVXXleZQNjjdEO6YZVq6anO60g==",
                        ...
                        new
                        {
                            ...
                            Password = "AQAAAAIAAYagAAAAEPI9Ea64RmWTHzGgU6EbZpUvWV71hRz7K+aiStnYvSP8vVsrhjLC/MVy8zYtmhj5XQ==",
                        ...
                        new
                        {
                            ...
                            LastName = "Wróbel",
                            Password = "AQAAAAIAAYagAAAAEDRxjLtZ1uwJTrU64mBSHtV9H/7xVEB13BYvDfSUvXN4a2fid/eX5QycQrWLtpgHEQ==",
                        ...
                        new
                        {
                            ...
                            LastName = "Kamiński",
                            Password = "AQAAAAIAAYagAAAAENUPSwPSvjTyygq6/zKq7UonWcMBRG+fOc81yoay+KF7Xbf1OPHsKUg45gGBlFAAkg==",
            ...
            modelBuilder.Entity("AudioEngineersPlatformBackend.Domain.Entities.UserLog", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            IdUserLog = new Guid("5cb8efaa-2432-46d1-9984-b41a40bab7b3"),
                            DateCreated = new DateTime(2025, 7, 2, 14, 50, 15, 891, DateTimeKind.Utc).AddTicks(5290),
                            IsDeleted = false,
                            IsVerified = true
                        },
                        new
                        {
                            IdUserLog = new Guid("2f765163-6728-48bc-9767-66687efdf86e"),
                            DateCreated = new DateTime(2025, 7, 2, 14, 50, 15, 967, DateTimeKind.Utc).AddTicks(8010),
                            IsDeleted = false,
                            IsVerified = true
                        },
                        new
                        {
                            IdUserLog = new Guid("8312d4fd-fe6d-4001-a037-cde12000161d"),
                            DateCreated = new DateTime(2025, 7, 2, 14, 50, 16, 3, DateTimeKind.Utc).AddTicks(1830),
                            IsDeleted = false,
                            IsVerified = true
                        },
                        new
                        {
                            IdUserLog = new Guid("e7653083-1497-4aa0-a56b-dec32a61d71f"),
                            DateCreated = new DateTime(2025, 7, 2, 14, 50, 16, 39, DateTimeKind.Utc).AddTicks(3130),
                            IsDeleted = false,
                            IsVerified = true
                        },
                        new
                        {
                            IdUserLog = new Guid("9ae2c2f3-4ab1-4512-9832-7649d5ff61d8"),
                            DateCreated = new DateTime(2025, 7, 2, 14, 50, 16, 75, DateTimeKind.Utc).AddTicks(650),
                            IsDeleted = false,
                            IsVerified = true
                        },
                        new
                        {
                            IdUserLog = new Guid("5091bf83-df7d-4a54-a35b-31b44d1a1643"),
                            DateCreated = new DateTime(2025, 7, 2, 14, 50, 16, 111, DateTimeKind.Utc).AddTicks(9750),
                            IsDeleted = false,
                            IsVerified = true
                        },
                        new
                        {
                            IdUserLog = new Guid("df0a8813-0938-42a6-ac84-26298701f456"),
                            DateCreated = new DateTime(2025, 7, 2, 14, 50, 16, 147, DateTimeKind.Utc).AddTicks(4470),
                            IsDeleted = false,
                            IsVerified = true
                        },
                        new
                        {
                            IdUserLog = new Guid("2a019dc8-fe9f-4a63-b692-49e03f889f7f"),
                            DateCreated = new DateTime(2025, 7, 2, 14, 50, 16, 183, DateTimeKind.Utc).AddTicks(9190),
                            IsDeleted = false,
                            IsVerified = true
                        },
                        new
                        {
                            IdUserLog = new Guid("c91c99ca-fffd-42a5-9e6e-fa67d3c0f762"),
                            DateCreated = new DateTime(2025, 7, 2, 14, 50, 16, 219, DateTimeKind.Utc).AddTicks(6000),
                            IsDeleted = false,
                            IsVerified = true
                        },
                        new
                        {
                            IdUserLog = new Guid("8db9e713-d6f0-4f34-b348-c7da0c1a51d6"),
                            DateCreated = new DateTime(2025, 7, 2, 14, 50, 16, 255, DateTimeKind.Utc).AddTicks(6240),
                            IsDeleted = false,
                            IsVerified = true
                        },
                        new
                        {
                            IdUserLog = new Guid("32affe63-9bb3-4c86-bbf8-6d5e37c7fb3f"),
                            DateCreated = new DateTime(2025, 7, 2, 14, 50, 16, 291, DateTimeKind.Utc).AddTicks(4570),
                            IsDeleted = false,
                            IsVerified = true
                        },
                        new
                        {
                            IdUserLog = new Guid("cd9e4f1f-8edd-4488-b0da-256521a720e8"),
                            DateCreated = new DateTime(2025, 7, 2, 14, 50, 16, 327, DateTimeKind.Utc).AddTicks(9150),
                            IsDeleted = false,
                            IsVerified = false,
                            VerificationCode = "410942",
                            VerificationCodeExpiration = new DateTime(2025, 7, 3, 14, 50, 16, 327, DateTimeKind.Utc).AddTicks(9210)
                        });
                });
