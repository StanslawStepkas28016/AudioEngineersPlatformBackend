            ...
            modelBuilder.Entity("AudioEngineersPlatformBackend.Domain.Entities.Advert", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            CoverImageKey = new Guid("c8e2e5d4-90a5-4df4-8d04-7d4f642bd226"),
                        ...
                        new
                        {
                            ...
                            CoverImageKey = new Guid("be9ee3c6-0d6b-4a8d-9017-6366def2862e"),
                        ...
                        new
                        {
                            ...
                            CoverImageKey = new Guid("09ec9e49-6a75-4e4a-bb68-3f64daa8cc29"),
            ...
            modelBuilder.Entity("AudioEngineersPlatformBackend.Domain.Entities.Review", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            IdReview = new Guid("ca172a9a-cace-4a8b-b5d9-40f66bf05831"),
                            Content = "Agnieszka popisała się umiejętnościami :) Bardzo podobało mi się analogowe brzmienie, które wyciągnęła z moich kiepskich nagrań, polecam ją każdemu!",
                            IdAdvert = new Guid("33545021-1ffb-4f46-9df8-6242b8f0786f"),
                            IdReviewLog = new Guid("9b565901-99e9-4890-ab9a-c6856268fbd3"),
                            IdUser = new Guid("156765b0-84a0-4389-af75-78f2f36dea04"),
                            SatisfactionLevel = (byte)4
                        },
                        new
                        {
                            IdReview = new Guid("9517e133-299d-444a-ab79-f4dcc694a6c5"),
                            Content = "Podobało mi się bardzo profesjonalne podejście Agnieszki. Pracowałem z nią nad kilkoma utworami, tak jak z początku było mi ciężko, bo miała dużo wymagań, to z perspektywy czasu wiem, że było warto się tak napocić, płyta brzmi pięknie.",
                            IdAdvert = new Guid("33545021-1ffb-4f46-9df8-6242b8f0786f"),
                            IdReviewLog = new Guid("a805622e-ef58-4da7-a43a-7d6ed345279f"),
                            IdUser = new Guid("fdf7bda4-f40f-484f-bc40-adbf8aa98985"),
                            SatisfactionLevel = (byte)5
                        });
                });
            ...
            modelBuilder.Entity("AudioEngineersPlatformBackend.Domain.Entities.ReviewLog", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            IdReviewLog = new Guid("9b565901-99e9-4890-ab9a-c6856268fbd3"),
                            DateCreated = new DateTime(2025, 11, 24, 14, 33, 0, 0, DateTimeKind.Utc),
                            IsDeleted = false
                        },
                        new
                        {
                            IdReviewLog = new Guid("a805622e-ef58-4da7-a43a-7d6ed345279f"),
                            DateCreated = new DateTime(2025, 9, 21, 13, 12, 0, 0, DateTimeKind.Utc),
                            IsDeleted = false
                        });
                });
