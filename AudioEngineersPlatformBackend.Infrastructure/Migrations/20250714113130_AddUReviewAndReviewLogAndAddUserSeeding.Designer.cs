...
namespace AudioEngineersPlatformBackend.Infrastructure.Migrations
{
    ...
    [Migration("20250714113130_AddUReviewAndReviewLogAndAddUserSeeding")]
    partial class AddUReviewAndReviewLogAndAddUserSeeding
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AudioEngineersPlatformBackend.Domain.Entities.AdvertLog", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            IdAdvertLog = new Guid("1b84601e-e225-4e9d-93d2-911fb0a1569e"),
                            DateCreated = new DateTime(2025, 7, 14, 11, 31, 30, 187, DateTimeKind.Utc).AddTicks(8030),
                            IsActive = true,
                            IsDeleted = false
                        },
                        new
                        {
                            IdAdvertLog = new Guid("a9e9762a-2a67-46f3-b371-50405a100d58"),
                            DateCreated = new DateTime(2025, 7, 14, 11, 31, 30, 188, DateTimeKind.Utc).AddTicks(2970),
                            IsActive = true,
                            IsDeleted = false
                        },
                        new
                        {
                            IdAdvertLog = new Guid("b3d2dce1-a858-4312-937d-c56a6e0178cf"),
                            DateCreated = new DateTime(2025, 7, 14, 11, 31, 30, 188, DateTimeKind.Utc).AddTicks(3000),
                            IsActive = true,
                            IsDeleted = false
                        },
                        new
                        {
                            IdAdvertLog = new Guid("efe85186-52c9-4c46-b585-d4b47523db47"),
                            DateCreated = new DateTime(2025, 7, 14, 11, 31, 30, 188, DateTimeKind.Utc).AddTicks(3010),
                            IsActive = true,
                            IsDeleted = false
                        },
                        new
                        {
                            IdAdvertLog = new Guid("24ba6029-f88c-4b12-9a63-bf00c2d9f3e4"),
                            DateCreated = new DateTime(2025, 7, 14, 11, 31, 30, 188, DateTimeKind.Utc).AddTicks(3020),
                            IsActive = true,
                            IsDeleted = false
                        },
                        new
                        ...
                        {
                            IdAdvertLog = new Guid("993648ca-9d51-419a-85e8-046e8fc3162b"),
                            DateCreated = new DateTime(2025, 7, 14, 11, 31, 30, 188, DateTimeKind.Utc).AddTicks(3030),
                            IsActive = true,
                            IsDeleted = false
                        },
                        new
            ...
            modelBuilder.Entity("AudioEngineersPlatformBackend.Domain.Entities.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            LastName = "Kowalski",
                            Password = "AQAAAAIAAYagAAAAEEhsKgxJS/x5/QSRUObz/u1DP1x6rKdh4uRDLkxqbL7vP+62BpvTkJYiKBV93av/ag==",
                        ...
                        new
                        {
                            ...
                            LastName = "Nowak",
                            Password = "AQAAAAIAAYagAAAAEEu8Bdlta7ntDbw9MeEG2aOuQItwk2Pz9vLtgC/Y2pnjPvkQAc5xwfN5n0zSUxeIqA==",
                        ...
                        new
                        {
                            ...
                            LastName = "Kowalska",
                            Password = "AQAAAAIAAYagAAAAECYLrSoeYfZ1qWihSLNcwWetSGfhYGGqqTPozzRJNdaQJdlzxHmlldJ5Dv8ur3WROw==",
                        ...
                        new
                        {
                            ...
                            LastName = "Nowak",
                            Password = "AQAAAAIAAYagAAAAEALV5Ctuu55karTken8j2gxHsnZbWeYoSW4PUXI01agXKsKhzUNDG9y/FrzKTQkL1Q==",
                        ...
                        new
                        {
                            ...
                            LastName = "Maj",
                            Password = "AQAAAAIAAYagAAAAEB5ow4pGhm2ZXYMNsybjmOqeV5o9pXLofV6sJ5Wj4LZmsoHQ7uOJWeEbV4NNov+g5A==",
                        ...
                        new
                        {
                            ...
                            LastName = "Zieliński",
                            Password = "AQAAAAIAAYagAAAAEACw10rFpDTCSsDhierAD82uhZrEvFY6nY/B+q5Mi7F3xSMDFJNhUprRVnUZCFMtzQ==",
                        ...
                        new
                        {
                            ...
                            LastName = "Wójcik",
                            Password = "AQAAAAIAAYagAAAAEJdptrbd+j+xPX9jiesXUcg+Zdp9iSvsOZz0QBRNXRwFRweMkeVFo4W0K1VrooTn3A==",
                        ...
                        new
                        {
                            ...
                            LastName = "Wiśniewska",
                            Password = "AQAAAAIAAYagAAAAEH183m9REzf6TQslOYQmYUQvj0mBuwQLpTOHWkMeoDU/hNnxjf8fVvnD9LdzEWF4Ng==",
                        ...
                        new
                        {
                            ...
                            Password = "AQAAAAIAAYagAAAAEHzXzXgWcyF9QFRh3VKdb+0di+SldWfLZL5wmF6kf9+mFYjnYgPocOdLqSwslG+5Tg==",
                        ...
                        new
                        {
                            ...
                            LastName = "Wróbel",
                            Password = "AQAAAAIAAYagAAAAECFBTyFIA3qSeyxWrExnJrub7/5Hx9tcMlLCeick9u7nAuShG8iD5lPbvUG/D7PPZw==",
                        ...
                        new
                        {
                            ...
                            LastName = "Kamiński",
                            Password = "AQAAAAIAAYagAAAAEJaqKWBt+tGFSA3AJO2cjFsJAOTWallZgmBLcq+T58EMDqbhYTWeA1QmrTzlwm2jog==",
                        ...
                        new
                        {
                            ...
                            Password = "AQAAAAIAAYagAAAAEMTGLiJOIoFO6qgo/EwYKriSrnQWwbOvSqNl8NcCULTUUBLYBomj1N138EOP4l40Tg==",
                        ...
                        new
                        {
                            ...
                            LastName = "Dąbrowska",
                            Password = "AQAAAAIAAYagAAAAEOYZoaPhoo1KuOvl010pX6pNchcr+fgBNXWthYjQXclklWyo3IMkbAZN3TtpcvIqwA==",
            ...
            modelBuilder.Entity("AudioEngineersPlatformBackend.Domain.Entities.UserLog", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            IdUserLog = new Guid("5cb8efaa-2432-46d1-9984-b41a40bab7b3"),
                            DateCreated = new DateTime(2025, 7, 14, 11, 31, 29, 663, DateTimeKind.Utc).AddTicks(5040),
                            IsDeleted = false,
                            IsVerified = true
                        },
                        new
                        {
                            IdUserLog = new Guid("2f765163-6728-48bc-9767-66687efdf86e"),
                            DateCreated = new DateTime(2025, 7, 14, 11, 31, 29, 737, DateTimeKind.Utc).AddTicks(7160),
                            IsDeleted = false,
                            IsVerified = true
                        },
                        new
                        {
                            IdUserLog = new Guid("8312d4fd-fe6d-4001-a037-cde12000161d"),
                            DateCreated = new DateTime(2025, 7, 14, 11, 31, 29, 772, DateTimeKind.Utc).AddTicks(3620),
                            IsDeleted = false,
                            IsVerified = true
                        },
                        new
                        {
                            IdUserLog = new Guid("e7653083-1497-4aa0-a56b-dec32a61d71f"),
                            DateCreated = new DateTime(2025, 7, 14, 11, 31, 29, 807, DateTimeKind.Utc).AddTicks(4290),
                            IsDeleted = false,
                            IsVerified = true
                        },
                        new
                        {
                            IdUserLog = new Guid("9ae2c2f3-4ab1-4512-9832-7649d5ff61d8"),
                            DateCreated = new DateTime(2025, 7, 14, 11, 31, 29, 842, DateTimeKind.Utc).AddTicks(6760),
                            IsDeleted = false,
                            IsVerified = true
                        },
                        new
                        {
                            IdUserLog = new Guid("5091bf83-df7d-4a54-a35b-31b44d1a1643"),
                            DateCreated = new DateTime(2025, 7, 14, 11, 31, 29, 877, DateTimeKind.Utc).AddTicks(2320),
                            IsDeleted = false,
                            IsVerified = true
                        },
                        new
                        {
                            IdUserLog = new Guid("df0a8813-0938-42a6-ac84-26298701f456"),
                            DateCreated = new DateTime(2025, 7, 14, 11, 31, 29, 912, DateTimeKind.Utc).AddTicks(4220),
                            IsDeleted = false,
                            IsVerified = true
                        },
                        new
                        {
                            IdUserLog = new Guid("2a019dc8-fe9f-4a63-b692-49e03f889f7f"),
                            DateCreated = new DateTime(2025, 7, 14, 11, 31, 29, 947, DateTimeKind.Utc).AddTicks(7050),
                            IsDeleted = false,
                            IsVerified = true
                        },
                        new
                        {
                            IdUserLog = new Guid("c91c99ca-fffd-42a5-9e6e-fa67d3c0f762"),
                            DateCreated = new DateTime(2025, 7, 14, 11, 31, 29, 982, DateTimeKind.Utc).AddTicks(2970),
                            IsDeleted = false,
                            IsVerified = true
                        },
                        new
                        {
                            IdUserLog = new Guid("8db9e713-d6f0-4f34-b348-c7da0c1a51d6"),
                            DateCreated = new DateTime(2025, 7, 14, 11, 31, 30, 17, DateTimeKind.Utc).AddTicks(1630),
                            IsDeleted = false,
                            IsVerified = true
                        },
                        new
                        {
                            IdUserLog = new Guid("32affe63-9bb3-4c86-bbf8-6d5e37c7fb3f"),
                            DateCreated = new DateTime(2025, 7, 14, 11, 31, 30, 50, DateTimeKind.Utc).AddTicks(9290),
                            IsDeleted = false,
                            IsVerified = true
                        },
                        new
                        {
                            IdUserLog = new Guid("cd9e4f1f-8edd-4488-b0da-256521a720e8"),
                            DateCreated = new DateTime(2025, 7, 14, 11, 31, 30, 84, DateTimeKind.Utc).AddTicks(2940),
                            IsDeleted = false,
                            IsVerified = false,
                            VerificationCode = "103614",
                            VerificationCodeExpiration = new DateTime(2025, 7, 15, 11, 31, 30, 84, DateTimeKind.Utc).AddTicks(2990)
                        },
                        new
                        {
                            IdUserLog = new Guid("b0f3e786-f68b-46fe-8b18-f4a6e1150804"),
                            DateCreated = new DateTime(2025, 7, 14, 11, 31, 30, 118, DateTimeKind.Utc).AddTicks(8920),
                            IsDeleted = false,
                            IsVerified = true
                        },
                        new
                        {
                            IdUserLog = new Guid("dbf24f67-7457-47c3-a2af-a117d8e90b00"),
                            DateCreated = new DateTime(2025, 7, 14, 11, 31, 30, 153, DateTimeKind.Utc).AddTicks(5120),
                            IsDeleted = false,
                            IsVerified = true
                        });
                });
