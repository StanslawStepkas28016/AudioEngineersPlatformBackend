...
namespace AudioEngineersPlatformBackend.Infrastructure.External.S3Service;
...
public class S3Service : IS3Service
{
    ...
    public async Task<string> GetPreSignedUrlForReadAsync(
        string folder,
        string fileName,
        Guid key,
        CancellationToken cancellationToken
    ...
    public async Task<string> GetPreSignedUrlForUploadAsync(
        string folder,
        Guid key,
        string fileName,
        CancellationToken cancellationToken
