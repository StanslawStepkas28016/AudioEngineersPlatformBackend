...
public interface IAuthRepository
{
    ...
    Task<UserAuthLog> AddUserLogAsync(UserAuthLog userAuthLog, CancellationToken cancellationToken);
    ...
    Task<UserAuthLog?> FindUserLogByResetEmailTokenAsync(Guid resetEmailToken, CancellationToken cancellationToken);
    Task<UserAuthLog?> FindUserLogByResetPasswordTokenAsync(Guid resetPasswordToken, CancellationToken cancellationToken);
}